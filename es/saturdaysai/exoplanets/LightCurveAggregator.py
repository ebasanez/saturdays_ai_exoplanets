...
data_folder = project_folder/"data"/"lc_folded"/"no_centroid"
...
np.save(project_folder/"data"/"X_fold_noCentroid.npy", X)
np.save(project_folder/"data"/"y_fold_noCentroid.npy", y)
np.save(project_folder/"data"/"z_fold_noCentroid.npy", z)
