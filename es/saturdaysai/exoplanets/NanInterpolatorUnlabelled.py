...
X_filename = "X_fold_noCentroid_unlabelled.npy"
z_filename = "z_fold_noCentroid_unlabelled.npy"
...
np.save(project_folder/"data"/"X_fold_noCentroid_unlabelled_noNans.npy", Xnonans)
np.save(project_folder/"data"/"z_fold_noCentroid_unlabelled_noNans.npy", znonans)
